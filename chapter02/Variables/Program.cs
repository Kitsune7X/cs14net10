...
// var file2 = File.CreateText("something2.txt");
...
// population = 68_000_000; // Initialize this variable to 68 million using literal value.
// birthdate = new(1995, 2, 23); // Initialize this variable to Feb 23, 1995.
// location = new(10, 20); // Initialize the X and Y coordinates of this value.
